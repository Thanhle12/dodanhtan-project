...
var themes = [
  ["#000", "#95AB63", "#BDD684", "#E2F0D6", "#F6FFE0"],
...
function createInstructions() {
  ...
  text.innerHTML =
    '<span style="color:' +
    theme[0] +
    ';font-size:20px;">Love Forever!</span><br /><span style="font-size:15px;"><strong>I Love You Bống.</strong><br />I hope you are feel happy with this gift.<br />I love You!</span>';
  ...
  text.style.left = (100 - text.clientWidth) / 2 + "px";
  text.style.top = (100 - text.clientHeight) / 2 + "px";
